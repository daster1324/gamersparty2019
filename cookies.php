    ...
    <div id="main-container" class="container">
      <?php getHeader(); ?>
        ...
        <div id="div-cookies" class="container">
            ...
            <p>Pulsando el botón ¡Ok! se asume que usted acepta el uso de cookies.</p>
            
            <p>Cómo modificar la configuración de las cookies</p>
            
            <p>Usted puede restringir, bloquear o borrar las cookies de la GamersParty o cualquier otra página web utilizando su navegador. En cada navegador la operativa es diferente, la función de "Ayuda" le mostrará cómo hacerlo.</p>     
        </div>
